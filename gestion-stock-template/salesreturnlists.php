<?php
// Ensure no BOM or output is sent before session_start()
session_start();
// Redirect immediately if not logged in to avoid sending output before header()
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <a href="salesreturnlists.php?num_com=<?= $sale['num_com'] ?>" class="me-3" data-confirm-delete="Delete this sale? This action cannot be undone.">
