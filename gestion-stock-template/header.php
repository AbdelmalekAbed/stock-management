            ...
            <div class="dropdown-menu menu-drop-user">
                <div class="profilename">
                    ...
                    <a class="dropdown-item" href="profile.php"> <i class="me-2" data-feather="user"></i> My
                        Profile</a>
                    <hr class="m-0">
                    <a class="dropdown-item logout pb-0" href="header.php?id=<?= $_SESSION['admin']['id'] ?>" data-confirm-delete="Delete your administrator account? This action cannot be undone.">
