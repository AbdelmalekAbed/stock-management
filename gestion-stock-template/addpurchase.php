                ...
                <table class="table">
                  <thead>
                    <tr>
                      <th>Product Name</th>
                      <th>QTY</th>
                      <th>Purchase Price (<?= DISPLAY_CURRENCY ?>)</th>
                      <th class="text-end">Unit Cost (<?= DISPLAY_CURRENCY ?>)</th>
                      <th class="text-end">Total Cost (<?= DISPLAY_CURRENCY ?>)</th>
                      <th></th>
                    </tr>
                  </thead>
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><?= format_price($item['prix_achat']) ?></td>
                      <td class="text-end"><?= format_price($item['prix_uni']) ?></td>
                      <td class="text-end"><?= format_price($item['qte_achete'] * $item['prix_achat']) ?></td>
                      <td>
                        <a href="./addpurchase.php?num_pr=<?= $item['num_pr'] ?>&amp;num_app=<?= $item['num_app'] ?>" data-confirm-delete="Remove this product from the purchase?">
