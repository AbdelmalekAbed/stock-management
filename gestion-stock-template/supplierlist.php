<?php
// Start session and redirect early if not authenticated to avoid any headers-sent issues
session_start();
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <a class="me-3" href="supplierlist.php?id_sup=<?= $supplier['id'] ?>" data-confirm-delete="Delete this supplier? This action cannot be undone.">
