              ...
              <table class="table datanew">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><?= $pur['num_app']; ?></td>
                    <td><?= $pur['date_app']; ?></td>
                    <td><?= format_price($pur['total']); ?></td>
                    <td>
                      <a class="me-3" href="purchase-details.php?num_app=<?= $pur['num_app'] ?>">
                        <img src="assets/img/icons/eye.svg" alt="img" />
                      </a>
                      <a class="me-3" href="./purchaselist.php?num_app=<?= $pur['num_app']; ?>" data-confirm-delete="Delete this purchase record? This action cannot be undone.">
