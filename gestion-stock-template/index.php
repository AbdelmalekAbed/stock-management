...
// print_r($_SESSION);
?>
<?php // keep default behavior: if admin logged in, show dashboard; else redirect to signin ?>
<?php if (isset($_SESSION['admin'])):
    ...
    $total_purchases_display = convert_price_to_display($total_all_pur);
    $total_sales_display = convert_price_to_display($total_all_sales);
    $total_profit_display = convert_price_to_display($total_all_sales - $total_all_pur);
    // print_r($clients); 
?>
<!DOCTYPE html>
<html lang="en">
                    ...
                    <div class="col-lg-3 col-sm-6 col-12">
                        <div class="dash-widget">
                            ...
                            <div class="dash-widgetcontent">
                                <h5><span class="counters" data-count="<?= $total_purchases_display ?>"><?= number_format($total_purchases_display, 2) ?> <?= DISPLAY_CURRENCY ?></span></h5>
                                <h6>Total Purchases (<?= DISPLAY_CURRENCY ?>)</h6>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-6 col-12">
                        <div class="dash-widget dash1">
                            ...
                            <div class="dash-widgetcontent">
                                <h5><span class="counters" data-count="<?= $total_sales_display ?>"><?= number_format($total_sales_display, 2) ?> <?= DISPLAY_CURRENCY ?></span></h5>
                                <h6>Total Sales (<?= DISPLAY_CURRENCY ?>)</h6>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-6 col-12">
                        <div class="dash-widget dash2">
                            ...
                            <div class="dash-widgetcontent">
                                <h5><span class="counters" data-count="<?= $total_profit_display ?>"><?= number_format($total_profit_display, 2) ?> <?= DISPLAY_CURRENCY ?></span></h5>
                                <h6>Total Profit (<?= DISPLAY_CURRENCY ?>)</h6>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-6 col-12">
                        <div class="dash-widget dash3">
                            ...
                            <div class="dash-widgetcontent">
                <h5><span class="counters" data-count="<?= $total_all_pr ?>"><?= number_format($total_all_pr) ?></span>
                                </h5>
