...
$(document).on('click','[data-confirm-delete]',function(e){var message=$(this).attr('data-confirm-delete')||'Are you sure you want to delete this item?';if(!confirm(message)){e.preventDefault();e.stopImmediatePropagation();}});
